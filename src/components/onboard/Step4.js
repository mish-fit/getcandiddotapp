...
const Step4 = (props) => {
  ...
  const handleAffiliates = (e) => {
    ...
    affiliates.push({brand:selectedItems[selectedItems.length-1].value,code:affiliateCode.current.value})
    console.log(affiliates);
    setShowInput(false);
  }
  ...
  return(
    ...
    <Heading size={'lg'} marginBottom='20px'>Affiliate Codes</Heading>
      ...
      <Flex width='200px' style={{ display: showInput ? 'inline' : 'none' }} >
      ...
      <Button 
        ...
        color='white'
					width='120px'
          height='50px'
        marginRight='5px' _hover={{ bg: '#D7354A' }} onClick={back}>
				Back
			</Button>
			<Button 
				borderRadius={50}
